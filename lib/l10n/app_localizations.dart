...
abstract class AppLocalizations {
  ...
  /// No description provided for @adminAccountExists.
  ///
  /// In en, this message translates to:
  /// **'Admin account already exists'**
  String get adminAccountExists;

  /// No description provided for @errorCheckingAdmin.
  ///
  /// In en, this message translates to:
  /// **'Error checking or creating admin account: {error}'**
